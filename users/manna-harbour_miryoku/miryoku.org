...
For the ortho_5x15 layout there's a bit more space in the middle, the thumb keys are shifted one postion towards
the middle for a more comfortable position.

To build for any keyboard using this layout (5x15, idobo, punk75, xd75):
